...
multichannel fixture (tests/test_channels4.wav, written and re-verified by
tools/gen_channel_fixture.cc) gives every CHANNEL a unique RMS, which is what
makes "which channel did you measure?" answerable at all —
