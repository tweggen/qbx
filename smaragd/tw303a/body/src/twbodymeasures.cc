...
struct Row {
    ...
    double gyrFrac;       // of length, about CoM       VERIFY
};

// Order must match twBodySeg.
const Row kRows[(int) twBodySeg::Count] = {
    /* HeadNeck */ { 0.069, 0.130, 0.500, 0.300 },   // VERIFY all four
    /* Trunk    */ { 0.435, 0.288, 0.450, 0.370 },   // VERIFY all four
    /* UpperArm */ { 0.027, 0.186, 0.580, 0.280 },   // VERIFY all four
    /* Forearm  */ { 0.016, 0.146, 0.460, 0.280 },   // VERIFY all four
    /* Hand     */ { 0.006, 0.108, 0.790, 0.300 },   // VERIFY all four
    /* Thigh    */ { 0.142, 0.245, 0.410, 0.330 },   // VERIFY all four
    /* Shank    */ { 0.043, 0.246, 0.450, 0.260 },   // VERIFY all four
    /* Foot     */ { 0.014, 0.152, 0.500, 0.300 },   // VERIFY all four
};
