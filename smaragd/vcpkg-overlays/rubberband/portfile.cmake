...
#
# Smaragd overlay change: the upstream port selects `sleef` for x64-windows,
# but sleef fails to build under MinGW (x64-mingw-dynamic). Rubber Band's own
# dependency-free `builtin` FFT always compiles and is entirely adequate here —
# Smaragd materialises the warped signal ONCE offline (twGrainSource ctor), so
# FFT throughput is not on any hot path. This keeps the x64-mingw build free of
# the sleef dependency; other platforms are unchanged from upstream.
