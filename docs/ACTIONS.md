...
|---|---|---|---|
| `add-sample` | SAddSampleAction | objects/wave/src/saddsampleaction.cpp | `trackIndex` = "0", `filePath` = "", `timePos` = "0" |
| `add-to-selection` | SAddToSelectionAction | selection/src/saddtoselectionaction.cpp | `paths` = "" |
| `add-track` | SAddTrackAction | objects/track/src/saddtrackaction.cpp | `index` = "-1" |
...
| `insert-plugin` | SInsertPluginAction | objects/mixer/src/sinsertpluginaction.cpp | `trackPath`, `slotIndex` = "0", `format`, `uid`, `name`, `vendor`, `nIn` = "0", `nOut` = "0" |
| `load-project` | SLoadProjectAction | actions/src/sloadprojectaction.cpp | `path` = "" |
...
| `move-clip` | SMoveClipAction | objects/track/src/smoveclipaction.cpp | `clip`, `destTrack`, `startTime` = "0" |
| `move-track` | SMoveTrackAction | objects/track/src/smovetrackaction.cpp | `source`, `toIndex` = "-1" |
...
| `remove-plugin` | SRemovePluginAction | objects/mixer/src/sremovepluginaction.cpp | `trackPath`, `slotIndex` = "0", `format`, `uid`, `name`, `vendor`, `nIn` = "0", `nOut` = "0" |
| `remove-sample` | SRemoveSampleAction | objects/wave/src/sremovesampleaction.cpp | `trackIndex` = "0", `clipIndex` = "0", `filePath` = "", `timePos` = "0" |
| `remove-track` | SRemoveTrackAction | objects/track/src/sremovetrackaction.cpp | `index` = "0" |
| `render` | SRenderAction | actions/src/srenderaction.cpp | `filename` = "", `format` = "wav", `quality` = "10" |
| `reparent-track` | SReparentTrackAction | objects/track/src/sreparenttrackaction.cpp | `source`, `destParent`, `destIndex` = "-1" |
| `resize-clip` | SResizeClipAction | objects/cut/src/sresizeclipaction.cpp | `clip`, `startTime` = "0", `startOffset` = "0", `duration` = "0", `loopLength` = "0", `stretch` = "1.0" |
...
| `split-clip` | SSplitClipAction | objects/cut/src/ssplitclipaction.cpp | `clip`, `splitTime` = "0" |
