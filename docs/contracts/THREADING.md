...
The pump is paced by the RT's DRAIN, not by a timer: it renders while the ring has room and idles otherwise. A full ring is a counted drop. That is deliberate — a pump that waited would be a second thing the callback can block on.
