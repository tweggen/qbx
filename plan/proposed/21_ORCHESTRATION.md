...
- **Status 2026-08-18: measurement DONE, runner DONE, wizard NOT.** And one
...
| L6a loopback latency calibration | ◐ | | | measurement + runner done and MEASURED on hardware 2026-08-18 (1084 vs a claimed 1039; residual +0.94 ms); only the Options UI is left |
