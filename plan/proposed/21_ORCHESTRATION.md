...
- **Status 2026-08-18: measurement DONE, runner DONE, wizard NOT.** And one
  ...
  refuses. The positive case (a cable in place, a true round trip measured) is
  still unverified.
...
| L6a loopback latency calibration | ◐ | | | measurement + runner done 2026-08-18; wizard UI not built; POSITIVE case unverified (needs a cable) |
