...
| M2 warp.pcm load fix | ✅ done | 2026-07-25 | (this commit) | Byte-identical off/cold/hot (cmp); grain 13/13 both states; deltas 966/616 ms on fixture cases; full suite 68/68 — first 100%. BONUS: the long-standing teardown-segfault-after-PASS family root-caused (SActionRunner leaked SProject → workers outlived main into static destruction) and fixed two-layer (immortal store singleton + orderly runner teardown); historical crashers 25/25 clean-exit vs 2-3/25 before. See STATE.md 2026-07-25 M2 entry. |
